...
<center>
    ...
    <form action="<%=basePath%>admin/setMoney" method="post">
        ...
        <table border="0" width="645" cellpadding="10" cellspacing="0" style="word-break:break-all">
            <tr height="30">
                <td style="text-indent:5px"><b>付费设置 [ID值：${requestScope.info.id}]</b></td>
            </tr>
            ...
            <tr height="40" bgcolor="#F9F9F9">
                ...
                <td align="right">
                    <%
                        if (info.getPayfor().equals("1")) {
                    %>
                    <input type="submit" value="√设为付费" disabled="false">
                    <%
                    } else {
                    %>
                    <input type="submit" value="√设为付费" onclick="confirm('确定设为付费吗?')">
                    <%
                        }
                    %>
                </td>
                <td align="left">
                    <input type="button" value="×删除信息" onclick="deleteInfo('确定要删除吗?')">
                </td>
            </tr>
            <tr height="5">
                <td></td>
