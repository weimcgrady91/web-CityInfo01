    ...
    <body onload="showTime(time)">
        <table width="210" border="0" align="center" cellspacing="1" >            
            ...
            <tr height="25" bgcolor="#F0F0F0" align="center">
                <td style="border: 1px solid">日</td>
                <td style="border: 1px solid">一</td>
                <td style="border: 1px solid">二</td>
                <td style="border: 1px solid">三</td>
                <td style="border: 1px solid">四</td>
                <td style="border: 1px solid">五</td>
                <td style="border: 1px solid">六</td>
            </tr>
            ...
            <tr>
                <% 
                  for(int i=j*7;i<(j+1)*7;i++) { 
                      ...
                      <td width="30" height="23" align="center" bgcolor="gray" style="border: 1px solid"><font color="#FFFFFF"><b><%=days[i]%></b></font></td>
                <%    }else{ %>
                      <td width="30" height="23" align="center" style="border: 1px solid"><%=days[i]%></td>
                <%    }
                  }%>
            </tr>
            <% } %>
